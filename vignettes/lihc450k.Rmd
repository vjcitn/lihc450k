...
this example, a connection is made to a public HDF Object Store
(HSDS instance), and assay(lim) evaluates to a DelayedArray
wrapping the numerical data in the store.

lim2 = loadLIHC450k(useRemote=FALSE)
